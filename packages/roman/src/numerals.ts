const numbers = [
	...
	String.fromCodePoint(0x2163), /** #3 IV U+2163 roman numeral 4 */
	String.fromCodePoint(0x2164), /** #4 V U+2164 roman numeral 5 */
	String.fromCodePoint(0x2165), /** #5 VI U+2165 roman numeral 6 */
	String.fromCodePoint(0x2166), /** #6 VII U+2166 roman numeral 7 */
	String.fromCodePoint(0x2167), /** #7 VIII U+2167 roman numeral 8 */
	...
	String.fromCodePoint(0x216C), /** #12 L U+216C roman numeral 50 */
	String.fromCodePoint(0x216D), /** #13 Ⅽ U+216D roman numeral 100 */
	String.fromCodePoint(0x216E), /** #14 D U+216E roman numeral 500 */
	String.fromCodePoint(0x216F), /** #15 M U+216F roman numeral 1000 */
